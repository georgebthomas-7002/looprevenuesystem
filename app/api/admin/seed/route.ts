...
const pages = [
  ...
  // Legal
  { slug: 'privacy', title: 'Privacy Policy', description: 'Our privacy policy', showInMainNav: false, showInFooterNav: true, navOrder: 1 },
  { slug: 'terms', title: 'Terms of Service', description: 'Terms of service', showInMainNav: false, showInFooterNav: true, navOrder: 2 },
]
  ...
  try {
    ...
    for (const page of pages) {
      ...
      if (!existing) {
        ...
        results.push({ page: page.title, status: 'exists' })
      }
    }
